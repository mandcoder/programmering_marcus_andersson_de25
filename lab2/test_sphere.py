...
These tests confirm:
- Radius validation works properly.
- Volume and surface area formulas produce correct results.
- String and repr representations are consistent.
"""
...
def test_invalid_radius_type():
    with pytest.raises(TypeError):
        Sphere(0, 0, 0, "ten")  # måste vara int eller float
